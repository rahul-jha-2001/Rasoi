...
class CreateProductRequest(_message.Message):
    ...
    product: product
    Image: bytes
    def __init__(self, product: _Optional[_Union[product, _Mapping]] = ..., Image: _Optional[bytes] = ...) -> None: ...
...
class GetProductRequest(_message.Message):
    __slots__ = ("product_uuid", "store_uuid")
    PRODUCT_UUID_FIELD_NUMBER: _ClassVar[int]
    STORE_UUID_FIELD_NUMBER: _ClassVar[int]
    product_uuid: str
    store_uuid: str
    def __init__(self, product_uuid: _Optional[str] = ..., store_uuid: _Optional[str] = ...) -> None: ...

class UpdateProductRequest(_message.Message):
    __slots__ = ("product_uuid", "store_uuid", "product", "image")
    PRODUCT_UUID_FIELD_NUMBER: _ClassVar[int]
    STORE_UUID_FIELD_NUMBER: _ClassVar[int]
    PRODUCT_FIELD_NUMBER: _ClassVar[int]
    IMAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    product: product
    image: bytes
    def __init__(self, product_uuid: _Optional[str] = ..., store_uuid: _Optional[str] = ..., product: _Optional[_Union[product, _Mapping]] = ..., image: _Optional[bytes] = ...) -> None: ...
...
class DeleteAddOnRequest(_message.Message):
    __slots__ = ("add_on_uuid",)
    ADD_ON_UUID_FIELD_NUMBER: _ClassVar[int]
    add_on_uuid: str
    def __init__(self, add_on_uuid: _Optional[str] = ...) -> None: ...
...
class UpdateAddOnRequest(_message.Message):
    __slots__ = ("add_on_uuid", "add_on")
    ADD_ON_UUID_FIELD_NUMBER: _ClassVar[int]
    ADD_ON_FIELD_NUMBER: _ClassVar[int]
    add_on_uuid: str
    add_on: add_on
    def __init__(self, add_on_uuid: _Optional[str] = ..., add_on: _Optional[_Union[add_on, _Mapping]] = ...) -> None: ...
